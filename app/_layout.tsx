...
export default function RootLayout() {
  ...
  return <SessionContext.Provider value={{ session, setSession }}><StatusBar style="light" /><Stack screenOptions={{ headerStyle: { backgroundColor: '#0f172a' }, headerTintColor: '#f8fafc' }}><Stack.Screen name="index" options={{ title: 'Technician Login' }} /><Stack.Screen name="(tabs)" options={{ headerShown: false }} /><Stack.Screen name="runs/[id]" options={{ title: 'Diagnosis Run Timeline' }} /></Stack></SessionContext.Provider>;
}
